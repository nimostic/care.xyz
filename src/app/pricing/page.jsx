...
export default function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      features: ["Priority Matching", "NID Verified Only", "Insurance Coverage", "24/7 Support"],
      button: "Choose Plan",
      highlight: true
    },
    {
      ...
      features: ["Dedicated Manager", "Police Verified Staff", "Weekly Health Reports", "Emergency Ambulance"],
      button: "Get Premium",
      highlight: false
    }
  ];
    ...
    <section className="py-16 bg-slate-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900">Simple, Transparent <span className="text-teal-600">Pricing</span></h2>
          <p className="text-slate-500 mt-4">No hidden fees. Choose a plan that fits your family's needs.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, i) => (
            ...
            >
              ...
              <button className={`w-full py-4 rounded-2xl font-bold transition-all ${plan.highlight ? 'bg-teal-600 text-white hover:bg-teal-700 shadow-lg shadow-teal-200' : 'bg-slate-100 text-slate-700 hover:bg-slate-900 hover:text-white'}`}>
                {plan.button}
              </button>
            </motion.div>
          ))}
