...
export const metadata = {
  ...
  description:
    "Explore our professional home healthcare services including infant care, elderly companionship, post-surgery care, and skilled home nursing.",
  openGraph: {
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto">
            Explore our wide range of caregiving services designed to provide
            comfort, safety, and peace of mind for your loved ones.
          </p>
        </div>
        ...
        <div className="mt-20 bg-white p-12 rounded-[3rem] text-center border border-slate-100 shadow-sm">
          ...
          <p className="text-slate-500 mb-8">
            We offer personalized caregiving solutions for long-term needs.
          </p>
